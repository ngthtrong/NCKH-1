...
public class NotificationService {
    ...
    public List<NotificationView> list() {
        ...
        return executor.read(jdbc -> jdbc.query("""
                SELECT id,event_type,title,body,action_url,read_at,created_at
                FROM notifications
    ...
    public NotificationView markRead(UUID notificationId) {
        ...
        return executor.write(jdbc -> {
            ...
            return jdbc.queryForObject("""
                    SELECT id,event_type,title,body,action_url,read_at,created_at FROM notifications
                    WHERE tenant_id=? AND id=? AND recipient_user_id=?
    ...
    public record NotificationView(
            UUID id, String eventType, String title, String body, String actionUrl,
